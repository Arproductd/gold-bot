...
// tablo.gold قیمت‌ها رو تومانِ هر «گرم» می‌ده. مقیاس نمایشی ربات همونیه که milli.gold
// اعلام می‌کنه: تومانِ هر «سوت» (صدم گرم) — همون عددی که کاربر توی اپ می‌بینه.
// نسبت این دو دقیقاً ۱۰۰ است (مثلاً 23,863,000 تومان بر گرم = 238,630 تومان بر سوت).
function tablo_to_bot_scale($toman_per_gram)
{
    return (int) round($toman_per_gram / 100);
}
